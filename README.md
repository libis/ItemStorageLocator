...
<br>*Note: when using a barcode scanner, you should configure you barcode scanner to output either an 'enter' or a 'tab' signal upon scanning the barcode.*

<br>*Note: on some mobile devices (tablets, smartphones,...) the 'Enter' button does not always return a standard 'enter' signal. Use the 'tab' button to avoid this issue.*
